...
<details>
  ...
  <div style="max-width:920px; margin:18px auto; padding:30px; box-sizing:border-box;">
    <!-- Profile views -->
    <div style="display:flex; justify-content:flex-start; gap:30px; align-items:center; margin:10px 0 18px 0;">
    ...
    <!-- 3-column grid – 40px gap, columns shrink to content -->
    <div style="display:flex; gap:40px; justify-content:center; align-items:flex-start; flex-wrap:wrap;">
      <!-- LEFT -->
      <div style="flex:0 1 auto; display:flex; flex-direction:column; gap:40px; align-items:center;">
        <a href="https://www.codechef.com/users/someshdiwan7" target="_blank" rel="noopener noreferrer"
           title="CodeChef — someshdiwan7"
           style="display:flex; flex-direction:column; align-items:center; text-decoration:none; color:inherit; gap:30px; transition:transform .12s ease, opacity .12s ease;">
      ...
      <div style="flex:0 1 auto; display:flex; flex-direction:column; gap:40px; align-items:center;">
        <a href="https://ankiweb.net/shared/decks?search=Vocabulary%20Vault%20%E2%80%94%20Rich%20English%20vocab%20flashcards"
           ...
           style="display:flex; flex-direction:column; align-items:center; text-decoration:none; color:inherit; gap:40px; transition:transform .12s ease, opacity .12s ease;">
...
<p align="left">
  ...
  <img src="Assets/contrib-monthly-line.svg?v=18920143832" alt="Monthly contributions (line)" width="1000" />
</p>
...
<div align="center" style="margin-top: 20px;">
  <a href="https://github.com/Someshdiwan/Someshdiwan" rel="noopener">
    <img src="https://raw.githubusercontent.com/Someshdiwan/Someshdiwan/main/streak.svg?v=18919513606"
