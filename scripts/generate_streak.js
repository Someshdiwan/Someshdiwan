...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <defs>
    ...
    <style>
      ...
      .big { fill:url(#numGrad); font-weight:900; font-size:84px; text-anchor:middle; filter: drop-shadow(0 6px 8px rgba(0,0,0,0.18)); }
      .sub { fill:#444; font-size:16px; text-anchor:middle; }
      .egg-shadow { fill: rgba(0,0,0,0.12); }

      /* much slower, gentler animations */
      .floaty { animation: floaty 4200ms ease-in-out infinite; transform-origin: center; }
      .flicker { animation: flicker 3600ms ease-in-out infinite; transform-origin: center; }
      ...
      @keyframes flicker {
        ...
        30% { transform: scale(0.985); opacity:0.88; filter:brightness(0.95); }
        60% { transform: scale(1.02); opacity:1; filter:brightness(1.04); }
  ...
  <g clip-path="url(#cardClip)">
    ...
    <!-- Small top-right flame (kept inside card, visible) -->
    <g transform="translate(${width - 110}, 60) scale(0.55)" class="floaty">
    ...
    <!-- NEW: medium flame centered below number (above notch) -->
    <g transform="translate(${width/2}, 235) scale(0.9)" class="floaty">
      <ellipse cx="0" cy="16" rx="36" ry="10" fill="rgba(0,0,0,0.10)" />
      <g class="flicker">
        <path d="M36 -8 C26 -24 -8 -28 -18 -8 C-26 6 -18 34 12 36 C36 38 44 16 36 -8 Z" fill="#ffd16a" opacity="0.98"/>
        <path d="M24 8 C18 2 6 2 2 8 C0 12 4 18 12 18 C18 18 26 14 24 8 Z" fill="#fff7de" opacity="0.95"/>
      </g>
    </g>
