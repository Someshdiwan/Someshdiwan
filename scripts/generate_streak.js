  ...
  <g clip-path="url(#cardClip)">
    ...
    <g transform="translate(60,70)">
      <g class="floaty">
        <g class="flicker" transform="translate(0,0) scale(0.92)">
          ...
          <path d="M52 14 C46 8 44 10 40 16 C38 22 44 28 52 26 C58 24 64 18 52 14 Z" fill="#fff5d8" opacity="0.6"/>
        </g>
      </g>
    </g>
    ...
    <g transform="translate(${width/2}, 240) scale(0.98)" class="floaty">
      ...
      <g class="flicker">
        ...
        <path d="M8 -2 C6 -8 0 -10 -4 -2 C-4 0 -1 4 6 4 C9 4 12 2 8 -2 Z" fill="#fff7de" opacity="0.35"/>
      </g>
    </g>

    <!-- Small flicker near the big flame (inside the card, close to big flame) -->
    <g transform="translate(${width/2 + 44}, 220) scale(0.5)" class="floaty">
      <g class="flicker">
