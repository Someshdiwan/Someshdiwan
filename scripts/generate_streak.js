...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <!-- full card body (keeps inside the 420x300 view) -->
  <g filter="url(#cardShadow)" transform="translate(10, 12)">
    <path d="M10 8 h400 a20 20 0 0 1 20 20 v150 a20 20 0 0 1 -20 20 h-200 q-10 6 -20 6 t-20 -6 h-200 a20 20 0 0 1 -20 -20 v-150 a20 20 0 0 1 20 -20 z"
          fill="url(#cardGrad)" stroke="#f0e0a0" stroke-width="1.2"/>
    <path d="M372 48 q-8 14 -22 20" stroke="#f5e0a0" stroke-width="1.2" fill="none" opacity="0.7"/>
    <ellipse cx="340" cy="30" rx="7" ry="3.5" fill="#fff9e0" opacity="0.8"/>
  </g>

  <!-- left flame (moved inward and scaled so it never clips) -->
  <g transform="translate(28, 58)">
    <ellipse class="egg-shadow" cx="36" cy="86" rx="60" ry="16" opacity="0.11"/>
  ...
  <g transform="translate(${width - 92}, 62) scale(0.52)" class="flame-anim">
  ...
  <!-- texts (centered and vertically balanced) -->
  <g class="card-font" transform="translate(0, 8)">
    <text x="${width/2}" y="64" class="title">GitHub Streak</text>
    <text x="${width/2}" y="140" class="big">${escapeXml(daysText)}</text>
    <text x="${width/2}" y="178" class="sub">Days</text>
  </g>

  <!-- clickable overlay (transparent) -->
