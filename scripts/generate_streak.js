...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <defs>
    ...
    <style>
      ...
      .title { fill:#5a4a20; font-weight:700; font-size:20px; text-anchor:middle; letter-spacing:1px; }
      .big { fill:url(#numGrad); font-weight:900; font-size:80px; text-anchor:middle; filter: drop-shadow(0 4px 4px rgba(0,0,0,0.18)); }
      .sub { fill:#666; font-size:16px; text-anchor:middle; letter-spacing:0.5px; }
      .egg-shadow { fill: rgba(0,0,0,0.12); }
      .flame-anim { animation: floaty 2800ms ease-in-out infinite; transform-origin: 80px 60px; }
      .flame-flicker { animation: flicker 1600ms ease-in-out infinite; transform-origin: 80px 60px; }
  ...
  <!-- left flame (moved slightly left and up so it stays inside) -->
  <g transform="translate(44,32)">
    <ellipse class="egg-shadow" cx="28" cy="86" rx="70" ry="18" opacity="0.12"/>
    <g class="flame-anim" transform="translate(0,-6) scale(0.95)">
      <g class="flame-flicker" transform="translate(0,0)">
  ...
  <!-- top-right mini flame (moved slightly lower to avoid overlap) -->
  <g transform="translate(${width - 78}, 50) scale(0.62)" class="flame-anim">
    <ellipse cx="0" cy="26" rx="22" ry="7" fill="rgba(0,0,0,0.12)" />
    <path d="M20 -8 C12 -20 -6 -22 -12 -8 C-18 2 -12 26 6 28 C24 30 30 10 20 -8 Z" fill="#ffca28"/>
    <path d="M12 6 C8 0 0 0 -4 6 C-6 10 -2 14 6 14 C12 14 18 10 12 6 Z" fill="#fff3d8" opacity="0.92"/>
  </g>

  <!-- centered texts -->
  <g class="card-font">
    <text x="${width/2}" y="66" class="title">GitHub Streak</text>
    <text x="${width/2}" y="150" class="big">${escapeXml(daysText)}</text>
    <text x="${width/2}" y="186" class="sub">day streak</text>
  </g>
