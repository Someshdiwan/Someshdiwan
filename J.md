<details>
  ...
  <div style="max-width:920px; margin:18px auto; padding:12px; box-sizing:border-box;">
    ...
    <div style="display:flex; gap:36px; justify-content:center; align-items:flex-start; flex-wrap:wrap;">
      <!-- LEFT COLUMN -->
      <div style="flex:1 1 160px; min-width:140px; max-width:220px; display:flex; flex-direction:column; gap:18px; align-items:center;">
        ...
        <a href="https://www.duolingo.com/profile/Somesh99?via=share_profile_link" target="_blank" rel="noopener noreferrer"
      ...
      <!-- MIDDLE COLUMN -->
      <div style="flex:1 1 160px; min-width:140px; max-width:220px; display:flex; flex-direction:column; gap:18px; align-items:center;">
        <a href="https://ankiweb.net/shared/decks?search=Vocabulary%20Vault%20%E2%80%94%20Rich%20English%20vocab%20flashcards" target="_blank" rel="noopener noreferrer"
